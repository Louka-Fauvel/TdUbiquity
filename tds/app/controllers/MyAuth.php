...
class MyAuth extends \Ubiquity\controllers\auth\AuthController{
    ...
    #[Get(path: "newUserForm",name: "myAuth.newUserForm")]
	...
	public function newUser(){
        ...
        if (!CacheManager::$cache->exists($key)) {
            ...
            $this->showMessage('Création de compte', "Votre compte a été crée avec l'email <b>$email</b>","success", "user");
        } else {
            $this->showMessage('Création de compte', "Votre compte a été crée avec l'email <b>$email</b>","error", "user");
        }
	}
